...
def build():
    ...
    if not os.path.isfile(os.path.join(root_path, 'package.json')):
        return
    src_dir = os.path.join(root_path, 'dist')
    ...
    print(f'Copying dist to panels')
    dst_dir = os.path.join(panels_path, 'dataSplit')
    # clean destination
